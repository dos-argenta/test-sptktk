...
def title_loop():
    ...
    if os.name == "nt":
        while True:
            os.system(f'title TikTok Viewbot by @DOS~ARGENTA ^| success: {success} fails: {fails} reqs: {reqs} rps: {rps} rpm: {rpm}')
            time.sleep(0.1)

if __name__ == "__main__":
    os.system("cls" if os.name == "nt" else "clear"); os.system("title TikTok Viewbot by @DOS~ARGENTA" if os.name == "nt" else "")
...
\ \  \|\  \ \  \__/                                                             
 ...
 ________  _________  ________  ___       ___  __    _______   ________         
|\   ____\|\___   ___\\   __  \|\  \     |\  \|\  \ |\  ___ \ |\   __  \        
\ \  \___|\|___ \  \_\ \  \|\  \ \  \    \ \  \/  /|\ \   __/|\ \  \|\  \       
 \ \_____  \   \ \  \ \ \   __  \ \  \    \ \   ___  \ \  \_|/_\ \   _  _\      
  \|____|\  \   \ \  \ \ \  \ \  \ \  \____\ \  \\ \  \ \  \_|\ \ \  \\  \|     
    ____\_\  \   \ \__\ \ \__\ \__\ \_______\ \__\\ \__\ \_______\ \__\\ _\     
   |\_________\   \|__|  \|__|\|__|\|_______|\|__| \|__|\|_______|\|__|\|__|    
   \|_________|`                            \n"""
    print(
        Colorate.Vertical(
